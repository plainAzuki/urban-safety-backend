...
# 公式情報の構造化と保持に関する設定。
OFFICIAL_FETCH_MIN_INTERVAL_MINUTES = int(env_value("OFFICIAL_FETCH_MIN_INTERVAL_MINUTES", "30"))
...
OFFICIAL_BACKGROUND_SYNC_ENABLED = env_value("OFFICIAL_BACKGROUND_SYNC_ENABLED", "false").lower() == "true"
OFFICIAL_BACKGROUND_INTERVAL_MINUTES = int(env_value("OFFICIAL_BACKGROUND_INTERVAL_MINUTES", "30"))
